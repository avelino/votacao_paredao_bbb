...
from london.core.files.uploadedfile import TemporaryUploadedFile, InMemoryUploadedFile
...
class StopUpload(UploadFileException):
    ...
    def __unicode__(self):
        if self.connection_reset:
            return unicode('StopUpload: Halt current upload.')
        else:
            return unicode('StopUpload: Consume request data, then halt.')
