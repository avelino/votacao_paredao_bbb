...
from london.utils import dateformat, numberformat, datetime_safe
from london.utils.imports import import_anything
from london.utils.encoding import smart_str
from london.utils.functional import lazy
from london.utils.safestring import mark_safe
from london.utils.translation import get_language, to_locale, check_for_language
...
def time_format(value, format=None, use_l10n=None):
    ...
    be localized (or not), overriding the value of settings.USE_L10N.
    """
    return dateformat.format(value, get_format(format or 'TIME_FORMAT', use_l10n=use_l10n))
